...
<html lang="en">
    <head>
        ...
        <title>
            Edit Listing (Unregistered) &middot; 
        </title>
                ...
                <div class="col-md-10 content ">
                    <div class="dashhead">
                        <div class="dashhead-titles">
                            ...
                            <h2 class="dashhead-title" style="color: #ffb71b; font-weight: 500;">Update Listing (Unregistered)
                            </h2>
                        </div>
                    </div>
                    <hr class="m-t">
                    <div class="pt-1 ml-1 px-5" >
                        <div class="card card-5" >
                            <div class="card-heading">
                                <h2 class="title">Update Listing (Unregistered)</h2>
                            </div>
                            <div class="card-body">
                                <form action="Trade" method="POST" id="submit_form" class="needs-validation " novalidate>
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <div class="value float-right">
                                                <div class="input-group">
                                                    <p readonly class="form-control-plaintext text-success ml-3">Email here</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div hidden id="category1"></div>
                                    <div class="form-row">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="value">
                                            <div class="input-group">
                                                <input class="input--style-5" type="text" id="title" name="title" value="TITLE" required>
                                                <div class="valid-feedback">Valid.</div>
                                        ...
                                        <div class="value">
                                            <div class="input-group">
                                                <textarea class="input--style-5" rows="4" id="description"
                                                          name="description" required="true" style="line-height:25px!important">DESCRIPTION</textarea>
                                                <div class="valid-feedback">Valid.</div>
                                        ...
                                        <div class="value">
                                            <div class="input-group">
                                                <input class="input--style-5" id="price" type="number" min="0" step="0.01"
                                                       name="price" value="1.123456" required="true">
                                                <div class="valid-feedback">Valid.</div>
                                    ...
                                    <div class="form-row">
                                        <div class="name" for="image">Image Upload</div>
                                        <div class="value">
                                            <div class="input-group">
                                                <input class="" id="image" type="file" name="image" style="color: #555; padding: 0 22px;
                                                       font-size: 16px;">
                                                <div class="valid-feedback">Valid.</div>
                                                <div class="invalid-feedback">Please enter a price.</div>
                                            </div>
                                        ...
                                        <div class="value">
                                            <div class="input-group">
                                                <input placeholder="(XXX-XXX-XXXX)" class="" type="tel"
                                                       pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" id="Number" name="phone" value="111-111-1111" required>
                                                <div class="valid-feedback">Valid.</div>
                                                <div class="invalid-feedback">Please fill out this field.</div>
                                            </div>
                                        </div>
                                    ...
                                    <div>
                                        <button class="btn1 btn1--red" id="submitItem" type="submit">Publish</button>
                                        <button class="btn1 btn1--red" id="" type="submit">Submit Changes</button>
                                        <button class="btn1 btn1--red" id="" type="submit">Delete Listing</button>
                                    </div>
                                </form>
                            </div>
                        </div>
