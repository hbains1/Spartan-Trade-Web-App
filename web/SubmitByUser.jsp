                ...
                <div class="col-md-9 content ">
                    <div class="dashhead">
                        <div class="dashhead-titles">
                            ...
                            <h2 class="dashhead-title" style="color: #ffb71b; font-weight: 500;">Create Listing by User
                            </h2>
                        </div>
                    </div>
                    <hr class="m-t">
                    <div class="pt-1 ml-1 px-auto" >
                        <div class="card card-5" >
                            ...
                            <div class="card-body">
                                <form enctype="multipart/form-data" action="Trade" method="POST" id="submit_form" class="needs-validation " novalidate>
                                    ...
                                    <div>
                                        <button class="btn1 btn1--red" id="submitItem" type="submit" value="Submit Item">Submit</button>
                                    </div>
                                </form>
                            </div>
                        </div>
