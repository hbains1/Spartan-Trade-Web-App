...
* another ajax form validation code I found
  ...
  $(document).ready(function(){
    $("#but_submit").click(function(){
        ...
        if( username != "" && password != "" ){
            $.ajax({
                url:'checkUser.php', //initial page, needß to be change
                type:'post',
                data:{username:username,password:password},
                success:function(response){
                    var msg = "";
                    if(response == 1){
                        window.location = "home.php"; //final destination, needs to be change
                    }else{
